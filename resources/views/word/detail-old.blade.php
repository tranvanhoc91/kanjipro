...
<div class="row">
					...
					<form class="form">
						<div class="form-body">
							<div class="form-group">
								<a data-toggle="collapse" data-parent="#accordionWrapa1" href="#accordion3" aria-expanded="true" aria-controls="accordion3" class="">コメント欄</a>
							...
							<div id="accordion3" role="tabpanel" aria-labelledby="heading3" class="card-collapse collapse in" aria-expanded="true" style="">
								<div class="form-group">
	...
	<div class="col-lg-4 col-xs-12">
		<img class="img-fluid" src="http://localhost/kanjimaster/public/template/assets/images/test/portfolio-1.jpg">
		
	</div>

	<div class="col-lg-4 col-xs-12"><!-- card -->
